...
class PatchGeneratorPixel:
    ...
    def __init__(self, slide_path, slide_level) -> None:
        ...
        self.patch_dir_path = 'save_level4_npy_temp/'
    ...
    def read_lvl4_then_write(self):
        """
        Reads level 4 resolution image
        """
        slide_openslide = OpenSlide(self.slide_path)
        img_openslide = slide_openslide.read_region((0, 0), 4, slide_openslide.level_dimensions[4])
...
if __name__ == "__main__":
    ...
    #print( np.where(slides_list_staged == '108b068f-117a-4ca6-8bdb-4d752d681636') )
