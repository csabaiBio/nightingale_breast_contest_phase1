...
class PatchGeneratorPixel:
    ...
    def __init__(self, slide_path, slide_level) -> None:
        ...
        self.patch_dir_path = 'save_level5_npy_holdout/'
    ...
    def read_lvl5_then_write(self):
        """
        Reads level 5 resolution image
        """
        slide_openslide = OpenSlide(self.slide_path)
        img_openslide = slide_openslide.read_region((0, 0), 5, slide_openslide.level_dimensions[5])
...
if __name__ == "__main__":
    ...
    for slide_path in slides_list_staged[ idx_to_run_now[0]:idx_to_run_now[1] ]:
        ...
        patch_generator.read_lvl5_then_write()
